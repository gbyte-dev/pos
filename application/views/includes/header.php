                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div>
                                                <img src="<?php echo base_url()?>assets/images/megamenu-img.png" alt=""
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            ...
                            <img id="header-lang-img" src="<?php echo base_url()?>assets/images/flags/us.jpg" alt="Header Language"
                                height="16">
                        </button>
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="#"><i
                                    ...
                                    key="t-lock-screen">Lock screen</span></a>
                                     ...
                                     <a class="dropdown-item" href="<?php echo base_url()?>Login/change_password"><i
                                    class="bx bx-lock-open font-size-16 align-middle me-1"></i> <span
                                    key="t-change-password">Change Password</span></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-danger" href="<?php echo base_url()?>Login?msg=logout"><i
