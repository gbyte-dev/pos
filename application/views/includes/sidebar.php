<div class="vertical-menu">
       ...
       <li>
                            <a href="<?php echo base_url().'ProductController/readProduct'?>" class="waves-effect">
						...
						<li>
                            <a href="<?php echo base_url().'ProductController/category_view'?>" class="waves-effect">
                                <i class="bx bx-chat"></i>
						...
						<li>
                            <a href="<?php echo base_url().'ProductController/subcategory_view'?>" class="waves-effect">
                                <i class="bx bx-chat"></i>
                                 <span key="t-chat">SubCategory</span>
                            </a>
                        </li>
