               ...
               <!-- end row -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
<a href="<?php echo base_url().'addProduct'?>" class="btn btn-primary m-auto">Add Product</a><br/><br/>
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <td class="text-center"><img src="<?php echo base_url()?>/assets/singleProductImg/<?php echo $res['display_image'];?>" height="60" width="100" style="object-fit:cover;"/></td>
                                        <?php }else{?>
                                        <td>No Image</td>
                                        <?php } ?>
		<td class="text-center"><?php if($res['status']==1){echo "Active";}else{echo "Inactive";}?></td>
                                        <td class="text-center">
                                            <a href="<?php echo base_url().'editProduct?id='.$res['id'];?>" class="btn btn-success btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                            <a onclick="remove('<?php echo base_url().'deleteProduct?id='.$res['id'];?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url() ?>addBulk" method="post" enctype='multipart/form-data'>
...
<a href="<?php echo base_url()."assets/bulk_files/import_product.csv"?>" download="import_product.csv">Download Sample CSV</a>
