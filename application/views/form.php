...
<form action="<?= base_url() ?>addProd" method="post" enctype='multipart/form-data'>
                            <div class="row mb-4">
                             ...
                             <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" name="cost_price" class="form-control" id="cost_price" placeholder="Enter Cost Price" onkeypress="return isNumber(event)" required>
                                </div>
                            </div>
                           
                            <div class="row mb-4">
                                <label for="selling_price" class="col-sm-3 col-form-label">Marked Price</label>
                                <div class="col-sm-9">
                                  <input type="text" name="selling_price" class="form-control" id="selling_price" placeholder="Enter Selling Price" onkeypress="return isNumber(event)" required>
                                </div>
                            </div>
							 ...
							 <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" name="discounted_price" class="form-control" id="discounted_price" placeholder="Enter Discounted Price" onkeypress="return isNumber(event)" required>
                                </div>
                            </div>
							 ...
							 <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" name="tax" class="form-control" id="tax" placeholder="Enter Tax" onkeypress="return isNumber(event)" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                  <input type="file" name="image[]" class="form-control" id="image" placeholder="Enter Your " multiple>
                                </div>
                            </div>
                             ...
                             <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                  <input type="file" name="display_image" class="form-control" id="display_image" placeholder="Enter Your ">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                 <select name="supplier" id="supplier" class="form-control" >
                                    <option value="0">Select Supplier</option>
									  ...
									  ?>
                                    <option value="<?php echo $res['id'];?>"><?php echo $res['supplier_name'];?></option>
                                     <?php }
