...
<form action="<?= base_url() ?>addWare" method="post" enctype='multipart/form-data'>
                            <div class="row mb-4">
                             ...
                             <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" name="phone" class="form-control" id="phone" placeholder="Enter Phone" onkeypress="return isNumber(event)" required>
                                </div>
                            </div>
