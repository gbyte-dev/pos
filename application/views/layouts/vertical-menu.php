        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.php" class="logo logo-light">
                        ...
                        <img src="<?= base_url(); ?>assets/website_image/<?php echo $image;?>" alt="" height="70px" width="150px">
...
<a href="<?= base_url().'pos'; ?>" class="btn btn-primary">POS</a>
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <?php } ?>
                    <?php if ($lang == 'es') { ?>
                        <img src="<?= base_url(); ?>assets/images/flags/spain.jpg" alt="Header Language" height="16">
                    <?php } ?>
                    <?php if ($lang == 'de') { ?>
                        <img src="<?= base_url(); ?>assets/images/flags/germany.jpg" alt="Header Language" height="16">
                    <?php } ?>
                    <?php if ($lang == 'it') { ?>
                        <img src="<?= base_url(); ?>assets/images/flags/italy.jpg" alt="Header Language" height="16">
                    <?php } ?>
                    <?php if ($lang == 'ru') { ?>
                        <img src="<?= base_url(); ?>assets/images/flags/russia.jpg" alt="Header Language" height="16">
                    <?php } ?>
                </button>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item text-danger" href="<?php echo base_url()?>Login/logout"><i class="bx bx-power-off font-size-16 align-middle me-1 text-danger"></i> <span key="t-logout"><?php echo $language["Logout"]; ?></span></a>
                </div>
            </div>

            <div class="dropdown d-inline-block">
                <a href="<?= base_url() ?>settings_view" type="button" class="btn header-item noti-icon right-bar-toggle waves-effect">
                    <i class="bx bx-cog "></i>
                </a>
            </div>
...
<li>
                    <a href="<?php echo base_url().'products'?>" class="waves-effect">
                        ...
                        <span key="t-chat">Product(<?= product() ?>)</span>
                    </a>
                </li>
				
				<li>
                            <a href="<?php echo base_url().'categories'?>" class="waves-effect">
                                <i class="fa fa-list"></i>
                                 <span key="t-chat">Category(<?= category() ?>)</span>
                            </a>
                        </li>
						
						<li>
                            <a href="<?php echo base_url().'subcategories'?>" class="waves-effect">
                                <i class="fa fa-align-justify"></i>
                                 <span key="t-chat">SubCategory(<?= subCategory() ?>)</span>
                            </a>
                        </li>
				...
				<li>
                    <a href="<?php echo base_url().'customers'?>" class="waves-effect">
                        ...
                        <span key="t-chat">Customers(<?=   customers() ?>)</span>
                    </a>
                </li>
				
				<li>
                    <a href="<?php echo base_url().'brand'?>" class="waves-effect">
                       <i class="bx bx-chat"></i>
                        <span key="t-chat">Brand(<?= brand() ?>)</span>
                    </a>
                </li>
				...
				<li>
                    <a href="<?php echo base_url().'supplier'?>" class="waves-effect">
                       <i class="fas fa-store"></i>
                        <span key="t-chat">Supplier(<?=  supplier() ?>)</span>
                    </a>
                </li>
				...
				<li>
                   ...
                   <i class="fa fa-warehouse"></i>
                        <span key="t-chat">Warehouse(<?= warehouses() ?>)</span>
                    </a>
                </li>
				
				<li>
                    <a href="<?php echo base_url().'payments'?>" class="waves-effect">
                    <i class="bx bx-chat"></i>
                        <span key="t-chat">Payment Methods(<?= payment() ?>)</span>
                    </a>
                </li>
				
				
				<li>
                    <a href="<?php echo base_url().'pos'?>" class="waves-effect">
                         <i class="bx bx-chat"></i>
                        <span key="t-chat">POS</span>
                    </a>
                </li>
				
				
				<li>
                    <a href="<?php echo base_url().'biller'?>" class="waves-effect">
                        <i class="fa fa-file-invoice"></i>
                        <span key="t-chat">Billers(<?php echo  biller(); ?>)</span>
                    </a>
                </li>
				
				<li>
                    <a href="<?php echo base_url().'sales'?>" class="waves-effect">
                        <i class="fa fa-shopping-cart"></i>
                        <span key="t-chat">Sales(<?php  echo sales(); ?>)</span>
                    </a>
                </li>
				
				
				<li>
                    <a href="<?php echo base_url().'stocks'?>" class="waves-effect">
                     <i class="bx bx-chat"></i>
                        <span key="t-chat">Limited Stock(<?= limited_stock() ?>)</span>
                    </a>
                </li>
				
				
				<li>
                    <a href="<?php echo base_url().'coupons'?>" class="waves-effect">
                        <i class="fa fa-gift"></i>
                        <span key="t-chat">Coupons(<?= coupan()  ?>)</span>
                    </a>
                </li>
				
				<li>
                    <a href="<?php echo base_url().'expense_category'?>" class="waves-effect">
                          <i class="bx bx-chat"></i>
                        <span key="t-chat">Expense Category(<?=  expense() ?>)</span>
                    </a>
                </li>
				
				<li>
                    <a href="<?php echo base_url().'expense'?>" class="waves-effect">
                        <i class="fa fa-list"></i>
                        <span key="t-chat">Expense List(<?= expensel() ?>)</span>
                    </a>
                </li>
				
				<li>
                    <a href="<?php echo base_url().'account'?>" class="waves-effect">
                        <i class="fa fa-user"></i>
                        <span key="t-chat">Account List(<?= accountl() ?>)</span>
                    </a>
                </li>
				
				<li>
                    <a href="<?php echo base_url().'money_transfer'?>" class="waves-effect">
                         <i class="bx bx-chat"></i>
                        <span key="t-chat">Money Transfer(<?php echo moneyt();  ?>)</span>
                    </a>
                </li>
				<li>
                    <a href="<?php echo base_url().'transfer_product'?>" class="waves-effect">
                        <i class="fas fa-exchange-alt"></i>
                        <span key="t-chat">Stock Transfer(<?= stockt() ?>)</span>
                    </a>
                </li>
