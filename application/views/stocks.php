...
<?php } ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Limited Stock</h4>
		...
		<td class="text-center"><?php if($res['status']==1){echo "Active";}else{echo "Inactive";}?></td>
                                        <td class="text-center">
                                            <a href="<?php echo base_url().'editStockProduct?id='.$res['id'];?>" class="btn btn-success btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                            <a onclick="remove('<?php echo base_url().'deleteStockProduct?id='.$res['id'];?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
